...
.react-jinke-music-player-main.lisha-theme .rc-slider-rail {
    background-color: rgba(252, 227, 225, .09) !important
}
...
.react-jinke-music-player-main.lisha-theme .music-player-panel .progress-load-bar {
    background-color: rgba(252, 227, 225, .06) !important
}
...
.react-jinke-music-player-main.lisha-theme .audio-lists-btn > .group:hover, .react-jinke-music-player-main.lisha-theme .audio-lists-btn > .group:hover > svg {
    color: #9a5a5a
}
